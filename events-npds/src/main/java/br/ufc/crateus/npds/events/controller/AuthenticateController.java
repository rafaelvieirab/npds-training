...
import br.ufc.crateus.npds.events.controller.dto.AuthenticateRequest;
import br.ufc.crateus.npds.events.controller.dto.AuthenticateResponse;
import br.ufc.crateus.npds.events.service.MyUserDetailsService;
import br.ufc.crateus.npds.events.util.JWTUtil;
...
public class AuthenticateController {
    ...
    @PostMapping
    private ResponseEntity<?> createToken(@RequestBody AuthenticateRequest authenticateRequest) throws Exception {
        try {
